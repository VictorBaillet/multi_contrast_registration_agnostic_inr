...
class serial_registration_irn:
    ...
    def __init__(self, config_dict):
        self.config, model_config, model_registration_config, data_config, directories, self.training_args = training_config(config_dict)
    ...
    def fit(self):
        ...
        for epoch in range(self.config.TRAINING.EPOCHS):
            ...
            self.model_registration_name_epoch = f'{self.model_name}_e{int(epoch)}_model_registration.pt'
    ...
    def _training_iteration(self, epoch):
        ...
        model_path_reg = os.path.join(self.weight_dir, self.model_registration_name_epoch)
        ...
        if epoch == (self.config.TRAINING.EPOCHS -1):
            ...
            torch.save(self.network_registration.state_dict(), model_path_reg)
