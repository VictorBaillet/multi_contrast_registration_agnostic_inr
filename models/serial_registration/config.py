...
from models.serial_registration.experiment_utils.utils_config import create_model, create_datasets, compute_dataset_artifacts
...
def general_config(config_dict, verbose=True):
    ...
    # Model configuration
    model, model_registration = create_model(config.NETWORK, device)
